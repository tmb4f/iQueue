...
/*
  ...
  INTO #RptgTemp FROM
   (
    SELECT
	  ...
	  ,UPDATE_DATE AS [Last Modified Time]
  ...
  --            ([Appointment ID unhashed],[Appointment ID],[PAT_MRN_ID],[Unit Name],[Visit Type],[Appointment Type],[Expected Duration],[Appointment Status],
  ...
  --             [Clinic Appointment Time],[Clinic Appointment Length],[Treatment Plan],[Treatment Plan Provider],
		--	   [Intake Time],[Check-out Time],[Last Modified Time],[ETL_guid],[Load_Dte])

  --SELECT
  --  [Appointment ID unhashed] -- this will be in the table, but not in the flat file
  -- ,[Appointment ID]
  -- ,[PAT_MRN_ID]
  -- ,[Unit Name]
  -- ,[Visit Type]
